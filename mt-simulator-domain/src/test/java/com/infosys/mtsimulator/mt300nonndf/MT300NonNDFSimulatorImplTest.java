...
import com.infosys.mtsimulator.basesimulator.BaseSimulatorImpl;
...
class MT300NonNDFSimulatorImplTest {
    ...
    private static MT300NonNDFSimulator mt300NonNDFSimulator;
    private static String inputMessage;

    @BeforeAll
    public static void setup() {
        baseSimulator = new BaseSimulatorImpl();
        mt300NonNDFSimulator = new MT300NonNDFSimulatorImpl(baseSimulator);
    ...
    public void shouldReturnConvertedStringFromInputWithTypeAutoMatch() {
        ...
        try {
            resultMessage = mt300NonNDFSimulator.parse(inputMessage, "AM");
